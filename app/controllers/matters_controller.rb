class MattersController < ApplicationController
  ...
  private
  def matter_params
    params.require(:matter).permit(:id, :cause_number, :casename, :year, :client_id, :client, :attorney, :paralegal, :kind, :opposing_party, :opposing_counsel, :judge, :court, :status)
  end
end
